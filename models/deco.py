...
"""
DECO model and criterion classes.
"""
import torch
...
from .deco_convnet import build_deco_convnet
...
class DECO(nn.Module):
    ...
    def __init__(self, backbone, deco_convnet, num_classes, num_queries, aux_loss=False):
        ...
        Parameters:
            backbone: torch module of the backbone to be used. See backbone_resnet.py
            deco_convnet: torch module of the deco_convnet architecture, including encoder and decoder. See deco_convnet.py
        ...
        self.input_proj = nn.Conv2d(backbone.num_channels, 120, kernel_size=1)
    ...
    def forward(self, samples: NestedTensor):
        ...
        hs = self.deco_convnet(self.input_proj(src), self.query_embed.weight)[0]
...
class SetCriterion(nn.Module):
    """ This class computes the loss for DECO.
